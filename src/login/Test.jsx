...
export default function SignUp() {
  ...
  // console.log(userId, nickname, location, password, confirmpwd);
  ...
  const onSubmitHandler = async () => {
    if (validation()) {
      try {
        const data = await axios.post("http://3.34.98.245/user/signup", {
   ...
   <StLayout> 
    ...
    <StListContainer>
      ...
      <StInput 
        ...
        helperText="사용자 ID는 5자 이상이어야 하며 문자 또는 숫자를 포함해주세요."
        />
    ...
    <StListContainer>
      ...
      helperText="비밀번호는 8자 이상이어야 하며 문자와 숫자 1자 이상을 포함해주세요."
      /> 
      ) : (
      <StInput 
      id="password"  
...
//     if (validation()) {
//       try {
//     const data = await axios.post("http://3.34.98.245/user/signup/usercheck", {
//           username: userId,
//         });
//         console.log(data);
